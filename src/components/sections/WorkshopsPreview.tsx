      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <p className="text-sm text-luxury-muted font-sans font-light leading-relaxed">
          ...
          {upcoming.map((workshop) => (
            <motion.div
              ...
              className="bg-luxury-bg border border-luxury-border/80 p-8 rounded-sm shadow-xl flex flex-col space-y-6"
            >
              <div className="flex justify-between items-start">
                <span className="text-[9px] uppercase tracking-widest bg-luxury-accent/10 border border-luxury-accent/30 text-luxury-accent px-3 py-1 rounded-sm">
                  next cohort
                </span>
                <span className="text-xs text-luxury-muted font-sans flex items-center gap-1">
                  <Users size={12} className="text-luxury-accent" />
              ...
              {/* Detail Items */}
              <div className="grid grid-cols-2 gap-4 text-xs font-sans border-t border-b border-luxury-border/40 py-4">
              ...
              <div className="flex items-center justify-between pt-2">
                <div className="flex flex-col">
                  <span className="text-[10px] uppercase tracking-widest text-luxury-muted font-sans">
                    enrolment fee
                  </span>
                ...
                <Link
                  ...
                  className="px-6 py-2.5 bg-luxury-accent hover:bg-luxury-hover text-luxury-bg text-xs font-sans uppercase tracking-widest font-semibold rounded-sm transition-all duration-300"
